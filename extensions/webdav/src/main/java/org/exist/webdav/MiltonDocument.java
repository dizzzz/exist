...
public class MiltonDocument extends MiltonResource
    ...
    public Long getContentLength() {
        ...
        */
        ...
        final boolean isMacFinder = userAgentHelper.isMacFinder(HttpManager.request());
    ...
    @Override
    public LockResult refreshLock(final String token, final LockTimeout lockTimeout) throws NotAuthorizedException, PreConditionFailedException {
